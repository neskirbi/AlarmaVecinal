...
// existing height is ok as is, no need to edit it
    ...
    public void EnviarNotification(){
        funciones.Conexion("{\"id_grupo\":\""+funciones.GetIdGrupo()+"\",\"mensaje\":\""+funciones.GetNombre()+"<br>Envio un mensaje.\"}",funciones.GetUrl()+getResources().getString(R.string.url_SendNotifications));
    }
